...
class TestCreateLink:
    async def test_success_first_try(self, redirect_service, mock_uow, mock_redirect_repo, mock_short_code_generator, link_model):
    ...
    async def test_retry_then_success(self, redirect_service, mock_uow, mock_redirect_repo, mock_short_code_generator, link_model):
    ...
    async def test_exhaust_all_attempts(self, redirect_service, mock_uow, mock_redirect_repo, mock_short_code_generator, caplog):
        ...
        assert f"Failed to generate unique short code after {max_attempts} attempts" in caplog.text


class TestDeleteLink:
    async def test_exists(self, redirect_service, mock_uow, mock_redirect_repo, link_model):
